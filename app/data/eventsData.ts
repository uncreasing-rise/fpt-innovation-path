...
export const eventsData: Event[] = [
  {
    ...
    description: "Cơ hội cho các startup trình bày ý tưởng đột phá trước hội đồng các nhà đầu tư và chuyên gia công nghệ hàng đầu.",
    ...
    speakers: [
      { name: "Mr. John Doe", title: "CEO, TechCorp", img: "https://images.unsplash.com/photo-1568602471122-7832951cc4c5?q=80&w=1740&auto=format&fit=crop" },
      { name: "Ms. Jane Smith", title: "Partner, VN Ventures", img: "https://images.unsplash.com/photo-1580489944761-15a19d654956?q=80&w=1887&auto=format&fit=crop" }
    ],
    schedule: [
    ...
    partners: ["TechCorp", "VN Ventures", "Startup Vietnam Foundation"],
    registerLink: "#"
  },
  {
    ...
    description: "Khám phá các chiến lược tăng trưởng đột phá cho sản phẩm của bạn với các chuyên gia marketing hàng đầu trong ngành.",
    longDescription: "Trong buổi workshop 3 tiếng này, bạn sẽ được trang bị những kiến thức và công cụ cần thiết để xây dựng một cỗ máy tăng trưởng cho startup của mình. Từ A/B testing, viral loops đến tối ưu hóa phễu người dùng, chuyên gia Alex Growth sẽ chia sẻ những bí quyết thực chiến nhất.",
    eventType: "Workshop",
    location: "Online via Zoom",
    speakers: [
      { name: "Mr. Alex Growth", title: "Marketing Expert", img: "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?q=80&w=1760&auto=format&fit=crop" }
    ],
    schedule: [
    ...
    partners: ["FPT University", "Google for Startups"],
    registerLink: "#"
  }
];
